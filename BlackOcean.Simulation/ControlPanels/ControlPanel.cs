...
public class ControlPanel
{
    ...
    public PoweredComponentControl Reactor = new() { Name = "Reactor", Abbreviation = "RCT", Icon = "starfighter-twin-ion-engine-advanced" };
    public PoweredComponentControl EmergencyReactor = new() { Name = "Emergency Reactor", Abbreviation = "EPG", Icon = "light-emergency" };
    public PoweredComponentControl LifeSupport = new() { Name = "Life Support", Abbreviation = "LIS", Icon = "heart-pulse" };
    public PoweredComponentControl EnergyShield = new() { Name = "Energy Shield Generator", Abbreviation = "SHD^E", Icon = "shield-plus" };
    public PoweredComponentControl AblativeShield = new() { Name = "Ablative Shield Generator", Abbreviation = "SHD^A", Icon = "shield-quartered" };
    public PoweredComponentControl ImpulseDrive = new() { Name = "Impulse Drive", Abbreviation = "IMP", Icon = "rocket-launch" };
    public PoweredComponentControl WarpDrive = new() { Name = "Warp Drive", Abbreviation = "WRP", Icon = "coin-vertical" };
    public PoweredComponentControl EnergyWeapon = new() { Name = "Energy Weapon", Abbreviation = "LSR", Icon = "raygun" };
    public PoweredComponentControl Scanner = new() { Name = "Scanners", Abbreviation = "SCN", Icon = "radar" };
    public PoweredComponentControl Communications = new() { Name = "Communications Array", Abbreviation = "COM", Icon = "satellite-dish" };
    ...
    public Gauge Energy = new() { Name = "Energy", Unit = "watt", Min = 0, Max = 1000, Bands = Band.Build(Safe) };
    ...
    public Gauge HeatDelta = new() { Name = "Heat Gain", Unit = "watt", Min = 0, Max = 10000, Bands = Band.Build(Safe) };
